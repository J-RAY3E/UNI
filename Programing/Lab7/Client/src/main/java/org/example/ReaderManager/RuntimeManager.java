        ...
        try{
            ...
            while (this.handler.getState()) {
                if (!this.connection.isConnected()) {
                    ...
                    if (this.handler.getConnectionState()) {
                        NotificationManager.getInstance().pushMessage("Connection lost. Please reconnect.", MessageType.WARNING);
                        System.out.print("Insert HOST PORT (e.g., localhost 9316): ");
